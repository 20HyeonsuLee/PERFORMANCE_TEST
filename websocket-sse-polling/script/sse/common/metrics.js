...
// 메시지 관련 메트릭
export const messageCounter = new Counter('sse_messages_received');
export const latencyTrend = new Trend('sse_message_latency');
export const messageRate = new Rate('sse_message_success');

// 연결 관련 메트릭
export const connectionRate = new Rate('sse_connection_success');

...
export const options = {
  ...
  thresholds: {
    ...
    'message_latency': ['p(95)<100', 'p(99)<200'], // 지연시간 임계값
    'ws_connecting': ['p(95)<1000'],             // 연결 시간
  },
};
...
export default function(data) {
  ...
  if (result.success) {
    ...
    console.log(`🔴 [${sessionId}] Connection closed: messages=${result.messageCount}, avgLatency=${avgLatency.toFixed(2)}ms`);
  }
